import{_ as t,o as i,c as r,z as e,a}from"./chunks/framework.d5623306.js";const v=JSON.parse('{"title":"Livres","description":"","frontmatter":{"prev":false,"next":false,"image":"pittsburgh.jpg","caption":"Pittsburgh, PA, USA, juillet 2009"},"headers":[],"relativePath":"fr/teaching/books/index.md","filePath":"fr/teaching/books/index.md"}'),s={name:"fr/teaching/books/index.md"},n=e("h1",{id:"livres",tabindex:"-1"},[a("Livres "),e("a",{class:"header-anchor",href:"#livres","aria-label":'Permalink to "Livres"'},"​")],-1),o=e("p",null,"XXX",-1),l=e("pre",null,[e("code",null,`<p>Cette page reprend les livres que j'ai écrit ou co-écrit. Une partie de ces livres concerne l'informatique ou les mathématiques et ils sont publiés sous le label <a href="https://www.ukonline.be">UKO</a>. Les autres livres sont à propos de la promotion de l'informatique et de la programmation et sont publiés au nom de l'ASBL <a href="https://www.csited.be">CSITEd</a>.</p>
...
`)],-1),d=[n,o,l];function u(m,c,p,b,h,g){return i(),r("div",null,d)}const q=t(s,[["render",u]]);export{v as __pageData,q as default};
