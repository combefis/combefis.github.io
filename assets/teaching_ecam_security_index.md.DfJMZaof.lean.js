import{_ as n,c as t,j as e,a as s,o as a}from"./chunks/framework.xETXYpcG.js";const g=JSON.parse('{"title":"Computer Security","description":"","frontmatter":{"prev":false,"next":false,"image":"boston.jpg","caption":"Boston, MA, USA, July 2019"},"headers":[],"relativePath":"teaching/ecam/security/index.md","filePath":"teaching/ecam/security/index.md"}'),r={name:"teaching/ecam/security/index.md"};function l(c,i,o,d,h,u){return a(),t("div",null,i[0]||(i[0]=[e("h1",{id:"computer-security",tabindex:"-1"},[s("Computer Security "),e("a",{class:"header-anchor",href:"#computer-security","aria-label":'Permalink to "Computer Security"'},"​")],-1),e("p",null,"XXX",-1),e("pre",null,[e("code",null,`<p>The <i>« I502A Sécurité physique et logicielle »</i> activity, taught to 
...
`)],-1)]))}const p=n(r,[["render",l]]);export{g as __pageData,p as default};
