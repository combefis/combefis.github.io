import{_ as e,o as i,c as s,z as a,a as n}from"./chunks/framework.d5623306.js";const m=JSON.parse('{"title":"Hacking Password Hashes with Rainbow Tables","description":"","frontmatter":{"prev":false,"next":false,"image":"namur.jpg","caption":"Namur, Belgium, June 2018"},"headers":[],"relativePath":"teaching/ucourses/rainbowtable/index.md","filePath":"teaching/ucourses/rainbowtable/index.md"}'),t={name:"teaching/ucourses/rainbowtable/index.md"},o=a("h1",{id:"hacking-password-hashes-with-rainbow-tables",tabindex:"-1"},[n("Hacking Password Hashes with Rainbow Tables "),a("a",{class:"header-anchor",href:"#hacking-password-hashes-with-rainbow-tables","aria-label":'Permalink to "Hacking Password Hashes with Rainbow Tables"'},"​")],-1),r=a("p",null,"XXX",-1),l=a("pre",null,[a("code",null,`<p>The <i>« SE507µ Hacking Password Hashes with Rainbow Tables »</i> micro-course is about how to <b>secure a passwords database</b> with hashed passwords and how such a database can be attacked using <b>rainbow tables</b>, a data structure capitalising on time-memory trade-off.</p>
...
`)],-1),h=[o,r,l];function c(d,b,u,w,g,p){return i(),s("div",null,h)}const P=e(t,[["render",c]]);export{m as __pageData,P as default};
