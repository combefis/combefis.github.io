import{_ as n,c as s,j as i,a as t,o as a}from"./chunks/framework.xETXYpcG.js";const d=JSON.parse('{"title":"Introduction to Numerical Computing with SciPy","description":"","frontmatter":{"prev":false,"next":false,"image":"ottignies.jpg","caption":"Ottignies, Belgium, October 2018"},"headers":[],"relativePath":"teaching/ucourses/numcomp/index.md","filePath":"teaching/ucourses/numcomp/index.md"}'),o={name:"teaching/ucourses/numcomp/index.md"};function l(c,e,r,m,u,p){return a(),s("div",null,e[0]||(e[0]=[i("h1",{id:"introduction-to-numerical-computing-with-scipy",tabindex:"-1"},[t("Introduction to Numerical Computing with SciPy "),i("a",{class:"header-anchor",href:"#introduction-to-numerical-computing-with-scipy","aria-label":'Permalink to "Introduction to Numerical Computing with SciPy"'},"​")],-1),i("p",null,"XXX",-1),i("pre",null,[i("code",null,`<p>The <i>« NC301µ Introduction to Numerical Computing with SciPy »</i> micro-course proposes an introduction to <b>numerical computing</b>, that is, how to use computers and algorithms to perform numerical computations. The presented concepts are directly applied with the <b>Python SciPy ecosystem</b>.</p>
...
`)],-1)]))}const g=n(o,[["render",l]]);export{d as __pageData,g as default};
