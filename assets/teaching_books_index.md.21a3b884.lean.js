import{_ as t,o as a,c as r,z as e,a as i}from"./chunks/framework.d5623306.js";const v=JSON.parse('{"title":"Books","description":"","frontmatter":{"prev":false,"next":false,"image":"pittsburgh.jpg","caption":"Pittsburgh, PA, USA, July 2009"},"headers":[],"relativePath":"teaching/books/index.md","filePath":"teaching/books/index.md"}'),n={name:"teaching/books/index.md"},s=e("h1",{id:"books",tabindex:"-1"},[i("Books "),e("a",{class:"header-anchor",href:"#books","aria-label":'Permalink to "Books"'},"​")],-1),o=e("p",null,"XXX",-1),l=e("pre",null,[e("code",null,`<p>This page gathers the books that I authored or co-authored. The books I wrote are either about computer science or mathematics and published under the <a href="https://www.ukonline.be">UKO</a> label, or about promoting computer science and programming under the <a href="https://www.csited.be">CSITEd</a> non-profit organisation. They all are in French, so are the short descriptions for each book.</p>
...
`)],-1),d=[s,o,l];function c(u,m,p,h,b,g){return a(),r("div",null,d)}const k=t(n,[["render",c]]);export{v as __pageData,k as default};
