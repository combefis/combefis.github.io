import{_ as s,c as a,j as e,a as t,o as n}from"./chunks/framework.xETXYpcG.js";const f=JSON.parse(`{"title":"Système d'exploitation","description":"","frontmatter":{"prev":false,"next":false,"image":"taipei.jpg","caption":"Taipei, Taiwan, juillet 2014"},"headers":[],"relativePath":"fr/teaching/ecam/os/index.md","filePath":"fr/teaching/ecam/os/index.md"}`),l={name:"fr/teaching/ecam/os/index.md"};function d(r,i,o,m,c,p){return n(),a("div",null,i[0]||(i[0]=[e("h1",{id:"systeme-d-exploitation",tabindex:"-1"},[t("Système d'exploitation "),e("a",{class:"header-anchor",href:"#systeme-d-exploitation","aria-label":`Permalink to "Système d'exploitation"`},"​")],-1),e("p",null,"XXX",-1),e("pre",null,[e("code",null,`<p>Le cours <i>« I4030 – Operating Systems »</i>, destinée aux étudiants en première année de master ingénieur industriel en informatique et en électronique à l'<a href="https://www.ecam.be">ECAM Brussels Engineering School</a> (ECAM), concerne les <b>systèmes d'exploitation</b>. Le cours commence par expliquer ce qu'est un système d'exploitation et à quoi il sert. Il présente ensuite comment le CPU, la mémoire et les entrées-sorties sont gérées de la manière la plus efficace possible par le système d'exploitation. Enfin, il termine avec des concepts plus avancés et des systèmes d'exploitation plus spécifiques, notamment pour la gestion du temps réel.</p>
...
`)],-1)]))}const g=s(l,[["render",d]]);export{f as __pageData,g as default};
