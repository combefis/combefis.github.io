import{_ as i,o,c as s,z as e,a as n}from"./chunks/framework.d5623306.js";const E=JSON.parse('{"title":"From IoT Devices to the Cloud with the IBM Node-RED Tool","description":"","frontmatter":{"prev":false,"next":false,"image":"larnaca.jpg","caption":"Larnaca, Cyprus, November 2019"},"headers":[],"relativePath":"teaching/ucourses/nodered/index.md","filePath":"teaching/ucourses/nodered/index.md"}'),t={name:"teaching/ucourses/nodered/index.md"},d=e("h1",{id:"from-iot-devices-to-the-cloud-with-the-ibm-node-red-tool",tabindex:"-1"},[n("From IoT Devices to the Cloud with the IBM Node-RED Tool "),e("a",{class:"header-anchor",href:"#from-iot-devices-to-the-cloud-with-the-ibm-node-red-tool","aria-label":'Permalink to "From IoT Devices to the Cloud with the IBM Node-RED Tool"'},"​")],-1),a=e("p",null,"XXX",-1),l=e("pre",null,[e("code",null,`<p>The <i>« IT301µ From IoT Devices to the Cloud with the IBM Node-RED Tool »</i> micro-course presents the <b>IBM Node-RED tool</b> that proposes a visual programming languages following the event-driven programming model. It is typically used for <b>IoT applications</b>, connecting devices to the cloud.</p>
...
`)],-1),r=[d,a,l];function h(c,g,u,p,f,m){return o(),s("div",null,r)}const w=i(t,[["render",h]]);export{E as __pageData,w as default};
