import{_ as o,c as s,j as e,a as n,o as d}from"./chunks/framework.xETXYpcG.js";const p=JSON.parse('{"title":"From IoT Devices to the Cloud with the IBM Node-RED Tool","description":"","frontmatter":{"prev":false,"next":false,"image":"larnaca.jpg","caption":"Larnaca, Cyprus, November 2019"},"headers":[],"relativePath":"teaching/ucourses/nodered/index.md","filePath":"teaching/ucourses/nodered/index.md"}'),t={name:"teaching/ucourses/nodered/index.md"};function a(l,i,r,h,c,g){return d(),s("div",null,i[0]||(i[0]=[e("h1",{id:"from-iot-devices-to-the-cloud-with-the-ibm-node-red-tool",tabindex:"-1"},[n("From IoT Devices to the Cloud with the IBM Node-RED Tool "),e("a",{class:"header-anchor",href:"#from-iot-devices-to-the-cloud-with-the-ibm-node-red-tool","aria-label":'Permalink to "From IoT Devices to the Cloud with the IBM Node-RED Tool"'},"​")],-1),e("p",null,"XXX",-1),e("pre",null,[e("code",null,`<p>The <i>« IT301µ From IoT Devices to the Cloud with the IBM Node-RED Tool »</i> micro-course presents the <b>IBM Node-RED tool</b> that proposes a visual programming languages following the event-driven programming model. It is typically used for <b>IoT applications</b>, connecting devices to the cloud.</p>
...
`)],-1)]))}const f=o(t,[["render",a]]);export{p as __pageData,f as default};
