import{_ as e,o as n,c as s,z as i,a as t}from"./chunks/framework.d5623306.js";const S=JSON.parse('{"title":"Introduction to Numerical Computing with SciPy","description":"","frontmatter":{"prev":false,"next":false,"image":"ottignies.jpg","caption":"Ottignies, Belgium, October 2018"},"headers":[],"relativePath":"teaching/ucourses/numcomp/index.md","filePath":"teaching/ucourses/numcomp/index.md"}'),o={name:"teaching/ucourses/numcomp/index.md"},a=i("h1",{id:"introduction-to-numerical-computing-with-scipy",tabindex:"-1"},[t("Introduction to Numerical Computing with SciPy "),i("a",{class:"header-anchor",href:"#introduction-to-numerical-computing-with-scipy","aria-label":'Permalink to "Introduction to Numerical Computing with SciPy"'},"​")],-1),c=i("p",null,"XXX",-1),l=i("pre",null,[i("code",null,`<p>The <i>« NC301µ Introduction to Numerical Computing with SciPy »</i> micro-course proposes an introduction to <b>numerical computing</b>, that is, how to use computers and algorithms to perform numerical computations. The presented concepts are directly applied with the <b>Python SciPy ecosystem</b>.</p>
...
`)],-1),r=[a,c,l];function m(u,p,h,d,g,f){return n(),s("div",null,r)}const P=e(o,[["render",m]]);export{S as __pageData,P as default};
